...
// Добавлен метод (by Ivan Nikitin): дополним конструктор еще одним необязательным методом:
...
XMLRPCMessage.prototype.xml = function(){
  ...
  // Comment by Ivan Nikitin: формируем пролог документа
  if (this.xmlEncoding)
...
function dateToISO8601(date){
  ...
  var time = leadingZero(date.getHours()) + ":" + leadingZero(date.getMinutes()) + ":" + leadingZero(date.getSeconds());
