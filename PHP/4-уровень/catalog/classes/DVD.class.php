...
class DVD{
	...
	function __construct($id=0){
		$this->_id = $id;
		//бращение к статическому методу getInstance
		//$db = new DB();
		//бращение к статическому методу getInstance
	...
	*/
	...
	class BonusDVD extends DVD{
		function __construct($id=0){
			parent::__construct();
				//элемент массива tracks
			$this->_tracks[] = -1;
		}
		}
	class  DVDFactory{
		// принимает в качестве аргумента название необходимого класса,в нашем случае DVD
		public static function create($type){
			$class = ucfirst($type) . 'DVD';
			return new $class;
		}
	}
	//класс шаблона Стратегия
	class DVDStrategy{
		protected $_strategy;
